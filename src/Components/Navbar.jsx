import { FaBars, FaUserCircle, FaSignOutAlt, FaUser, FaTachometerAlt } from "react-icons/fa";
...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="px-4 md:px-6 lg:px-8 xl:px-12 py-3 md:py-4 flex items-center justify-between w-full">
        ...
        <div className="flex items-center gap-3 md:gap-4">
          {!isHomePage && (
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="sm:hidden p-2 text-gray-700 hover:text-sky-700 hover:bg-sky-50 rounded-lg transition-all duration-200"
        ...
        <div className="relative flex items-center gap-3 md:gap-4">
          {!user ? (
            ...
            <div className="relative">
              ...
              >
                <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-gradient-to-r from-sky-600 to-blue-600 text-white flex items-center justify-center font-bold text-sm md:text-base uppercase shadow-lg">
                ...
                {dropdownOpen && (
                  <>
                    ...
                    >
                      ...
                      {/* Menu Items */}
                      <div className="py-2">
                        <motion.div whileHover={{ backgroundColor: "rgba(14, 165, 233, 0.05)" }}>
                          <Link
                            to="/dashboard"
