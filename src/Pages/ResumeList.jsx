...
const steps = ['Personal Info', 'Education', 'Skills', 'Projects', 'Experience', 'Achievements', 'Contact'];
...
const ResumeForm = () => {
  ...
  const nextStep = () => {
    if (step === 0 && !formData.name.trim()) return toast.error('Name is required!');
  ...
  const renderStep = () => {
    switch (step) {
      case 0:
        return (
          <div className="space-y-4">
            <input type="text" placeholder="Full Name *" value={formData.name} onChange={(e) => handleChange(e, 'name')} className="input" />
            <textarea placeholder="Short Description" value={formData.description} onChange={(e) => handleChange(e, 'description')} className="input" />
          </div>
        );
      case 1:
        return (
        ...
        return (
          <div className="space-y-4">
            ...
            {formData.skills.map((skill, domainIndex) => (
              <div key={domainIndex} className="mb-6 border p-4 rounded bg-gray-50">
                <input
                  type="text"
                ...
                {skill.languages.map((lang, langIndex) => (
                  <input
                    ...
                    value={lang}
                    onChange={(e) => handleSkillChange(domainIndex, langIndex, e.target.value)}
                    className="w-full mb-2 px-3 py-2 border rounded"
                  />
                ))}
      ...
      case 3:
        return (
          <div>
            <h2 className="text-xl font-semibold mb-4 text-sky-700">Step 3: Projects</h2>

            {formData.projects.map((project, index) => (
              <div key={index} className="mb-6 border border-gray-200 p-4 rounded bg-gray-50">
                <input
                  type="text"
      ...
      case 4:
        return (
          <div>
            <h2 className="text-xl font-semibold mb-4 text-sky-700">Step 4: Experience</h2>
      ...
      case 5:
        return (
          <div>
            <h2 className="text-xl font-semibold mb-4 text-sky-700">Step 5: Achievements</h2>
              ...
              <div key={index} className="mb-6 border border-gray-200 p-4 rounded bg-gray-50">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    value={achieve.month}
                    onChange={(e) =>
                      handleArrayChange('achievements', index, 'month', e.target.value)
                    }
      ...
      case 6:
        return (
          <div>
            <h2 className="text-xl font-semibold mb-4 text-sky-700">Step 6: Contact Information</h2>

            <input
              type="text"
              placeholder="Phone Number"
              value={formData.contact.phone}
              onChange={(e) => handleSingleChange('contact', 'phone', e.target.value)}
            ...
            <input
              ...
              onChange={(e) => handleSingleChange('contact', 'email', e.target.value)}
              className="w-full mb-4 px-3 py-2 border rounded"
            />
            ...
            <input
              ...
              onChange={(e) => handleSingleChange('contact', 'github', e.target.value)}
              className="w-full mb-4 px-3 py-2 border rounded"
            />
            ...
            <input
              ...
              onChange={(e) => handleSingleChange('contact', 'linkedin', e.target.value)}
              className="w-full mb-4 px-3 py-2 border rounded"
            />
            ...
            <input
              ...
              onChange={(e) => handleSingleChange('contact', 'location', e.target.value)}
              className="w-full mb-4 px-3 py-2 border rounded"
            />
          </div>
        );
      ...
      default:
        return <p className="text-center text-gray-500">More sections coming…</p>;
    }
  };
